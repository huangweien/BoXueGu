...
public class VideoListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        chapterId = getIntent().getIntExtra("id",0);//从课程界面传过来的章节id
        intro = getIntent().getStringExtra("intro");//从课程界面传过来的章节简介
    ...
    private void init() {
        ...
        adapter = new VideoListAdapter(this,new VideoListAdapter.OnSelectListener(){
            ...
            public void onSelect(int position, ImageView iv) {
                adapter.setSelectedPosition(position);//设置适配器选项
                ...
                if (TextUtils.isEmpty(videoPath)){
                    ...
                    if (readLoginStatus()){//判断用户是否登录，若登录则把此视频添加到数据库
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null){//接受播放界面传回的被选中的视频数据
